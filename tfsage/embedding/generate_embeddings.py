...
import tempfile
import os
from ..utils import write_10x_h5
...
def run_seurat_integration(
    ...
    Parameters:
        rp_matrix (str): Path to the RP matrix file (input, h5 format).
...
def generate_embeddings(
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        rp_matrix_path = os.path.join(temp_dir, "rp_matrix.h5")
        ...
        # Save the RP matrix as h5 file and metadata as Parquet file
        write_10x_h5(rp_matrix_df, rp_matrix_path)
